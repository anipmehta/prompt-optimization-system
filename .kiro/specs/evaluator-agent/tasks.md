...
- [x] 1. Extract shared async bridge and create evaluator package structure
  - [x] 1.1 Create `src/shared/` package with `__init__.py` and `async_utils.py`
  ...
  - [x] 1.2 Refactor `GeneratorAgent` to use shared async bridge
  ...
  - [x] 1.3 Create `src/evaluator_agent/` package with module stubs
...
- [x] 2. Implement EvaluatorConfig and prompt templates
  - [x] 2.1 Implement `DEFAULT_RUBRIC_TEMPLATE` in `prompt_templates.py`
  ...
  - [x] 2.2 Implement `EvaluatorConfig` frozen dataclass in `config.py`
...
- [x] 3. Implement score parser
  - [x] 3.1 Implement `parse_score()` in `score_parser.py`
...
- [x] 5. Implement EvaluatorAgent class
  - [x] 5.1 Implement `EvaluatorAgent.__init__()` in `agent.py`
  ...
  - [x] 5.2 Implement `EvaluatorAgent.evaluate()` in `agent.py`
...
- [x] 7. Wire up exports and create unit tests
  - [x] 7.1 Wire up `src/evaluator_agent/__init__.py` exports
    - Export `EvaluatorAgent`, `EvaluatorConfig`, `parse_score`, `DEFAULT_RUBRIC_TEMPLATE`
    - _Requirements: 1.2_

  - [x] 7.2 Create `tests/test_evaluator_agent.py` with unit tests
  ...
  - [x] 7.3 Create `tests/test_evaluator_config.py` with unit tests
  ...
  - [x] 7.4 Create `tests/test_score_parser.py` with unit tests
  ...
  - [x] 7.5 Create `tests/test_async_utils.py` with unit tests
